...
export function AiKeySlots({ model }: { model: ModelId }) {
  ...
  return (
    <section className="paper grain mt-4 p-5 sm:p-6" aria-labelledby="ai-keys-heading">
      ...
      <p className="mt-2.5 rounded-[var(--radius)] bg-ab px-3.5 py-3 text-[12.5px] leading-6 text-ink2">
        <b>راستىنى ئېيتقاندا:</b> توركۆرگۈگە ساقلانغان ھەرقانداق نەرسىنى، شۇ بەتتە
        پروگرامما ئىجرا قىلالايدىغان نەرسە ئوقۇيالايدۇ. بۇ سايتنىڭ قاتتىق CSP قوغدىنىشى بار
        ۋە كۆرسىتىلىدىغان بارلىق مەزمۇن تازىلىنىدۇ، شۇنداقتىمۇ{" "}
        <b>ئورتاق ئىشلىتىلىدىغان ياكى ئاممىۋى كومپيۇتېر</b> ئاچقۇچ ساقلاشقا مۇۋاپىق ئورۇن
        ئەمەس.
      </p>
